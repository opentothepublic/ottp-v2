    ...
    <div>
      ...
      <div className="mb-6">
        <div className="flex items-center gap-2 mb-2">
          ...
          {object.onchain_uid && (
            <a
              href={`https://base.easscan.org/attestation/view/${object.onchain_uid.replace("base:", "")}`}
              target="_blank"
        ...
        <div className="flex items-center gap-2 mt-3 text-xs text-zinc-600">
          ...
          >
            {object.owner ? getDisplayName(object.owner) : ""}
          </Link>
          <span>·</span>
      ...
      <div className="flex gap-2 mb-8">
        ...
        <AttestButton
          ...
          targetOwnerId={object.owner_subject_id}
          onAttested={() => {
            getLinksToObject(id).then(setInboundLinks);
          }}
        />
      </div>
          ...
          <div className="space-y-2">
            {inboundLinks.map((link) => {
              ...
              const srcTitle = src?.object
                ? getTitle(src.object)
                : src?.subject ? getDisplayName(src.subject) : "Unknown";
